	...
	<div class="col-md-12">
		<div class="card">
			<div class="card-header">
				...
				<a href="index.cfm?area=WebTop&action=AddCountryManager" style="width: auto;" class="btn btn-success custom-btn floatright">Add Country Manager</a>
			</div>
			<div class="card-body">
									...
									<cfloop query="qCountrySelect">
										<tr>
											...
											<td>
												...
												<a href="#cgi.script_name#?area=#url.area#&action=UpdateCountryManager&CountryID=#CountryID#">Edit</a>
